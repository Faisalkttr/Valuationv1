...
- **Ticker detail tab** -- valuation bar chart (median / 75th / current / 90th / forward
  P/S), a P/S-over-time trend line once the engine has run more than once, and the
  fundamentals cards + quality badge described above
